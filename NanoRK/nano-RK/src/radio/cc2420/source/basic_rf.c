...
//	while(SFD_IS_1);
        ...
        if (length < (RF_PACKET_OVERHEAD_SIZE + CHECKSUM_OVERHEAD) || (length-RF_PACKET_OVERHEAD_SIZE)> rfSettings.pRxInfo->max_length) // (RF_PACKET_OVERHEAD_SIZE + CHECKSUM_OVERHEAD) is RF_ACK_PACKET_SIZE
        {
