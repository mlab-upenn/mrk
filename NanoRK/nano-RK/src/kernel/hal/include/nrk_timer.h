...
extern uint8_t _nrk_prev_timer_val;
extern uint8_t _nrk_time_trigger;

extern void (*app_timer0_callback)(void);
extern uint8_t app_timer0_prescale;
...
/* Dalton Banks - removed all inline functions */
...
void _nrk_precision_os_start();
void _nrk_precision_os_reset();
uint16_t _nrk_precision_os_timer_get();

void _nrk_os_timer_reset();
void _nrk_os_timer_set(uint8_t v);
void _nrk_os_timer_stop();
void _nrk_os_timer_start();
/* Dalton Banks - changed from uint8_t */
uint16_t _nrk_os_timer_get();

// implemented in hardware specific assembly file
