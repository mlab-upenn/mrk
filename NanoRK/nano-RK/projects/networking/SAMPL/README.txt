...
SAMPL/transducer-pkts
These are custom transducer packets for application specific sensors or actuators.  If you are trying to add new sensors or transducers, this is where they should go.  Core SAMPL packet types or in the nano-RK/src/net/sampl directory.
