...
if(in_msg->type==TRAN_BINARY_SENSOR)
{
	out_msg->type=TRAN_BINARY_SENSOR;
	out_msg->payload[0]=(g_binary_sensor_value<<7) | g_binary_sensor_type;
	out_msg->len=1;
	return 1;
} else if(in_msg->type==TRAN_LED_BLINK)
{
