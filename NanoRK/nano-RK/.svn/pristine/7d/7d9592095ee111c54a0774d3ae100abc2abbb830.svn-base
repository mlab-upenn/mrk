...
uint8_t ff_basic_sensor_short_pack( TRANSDUCER_MSG_T *t, FF_SENSOR_SHORT_PKT_T *s );
uint8_t ff_basic_sensor_short_unpack( TRANSDUCER_MSG_T *t, FF_SENSOR_SHORT_PKT_T *s );
