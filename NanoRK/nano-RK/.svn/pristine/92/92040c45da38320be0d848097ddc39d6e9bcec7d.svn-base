 ...
 * System clock in Hz.
 */
#define F_CPU 16000000UL	/* 16 MHz for the AtMega128RFA1 */
...
/*
 * Note [3]
 * TWI address for Bosch EEPROM:
 */
//#define TWI_SLA_24CXX	0xEE
 ...
 *
 * Formula for setting the SCL clock frequency is on page 383 of the ATmega128RFA1 datasheet
 */
void init_i2c(void)
{
...
uart_putchar(char c, FILE *unused)
{
    ...
    printf("uart_putchar with char %c", c);
