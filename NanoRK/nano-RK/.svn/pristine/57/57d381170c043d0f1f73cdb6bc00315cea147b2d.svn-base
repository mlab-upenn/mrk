...
NRK_PIN(  GPIO_13,GPIO_13, NRK_PORTB )
NRK_PIN(  GPIO_12,GPIO_12, NRK_PORTB )
NRK_PIN(  GPIO_11,GPIO_11, NRK_PORTB )
NRK_PIN(  GPIO_10,GPIO_10, NRK_PORTB )
NRK_PIN(  GPIO_9,GPIO_9, NRK_PORTB )
NRK_PIN(  GPIO_8,GPIO_8, NRK_PORTB )


// Port D
NRK_PIN(  I2C_SCI,I2C_SCI,NRK_PORTD )
NRK_PIN(  I2C_SDA,I2C_SDA,NRK_PORTD )
...
NRK_PIN(  GPIO_4,GPIO_4,NRK_PORTE )
NRK_PIN(  GPIO_5,GPIO_5,NRK_PORTE )
NRK_PIN(  GPIO_6,GPIO_6,NRK_PORTE )
NRK_PIN(  GPIO_3,GPIO_3,NRK_PORTE )
NRK_PIN(  GPIO_2,GPIO_2,NRK_PORTE )
NRK_PIN(  GPIO_7,GPIO_7,NRK_PORTE )
//-------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------
// Port F
